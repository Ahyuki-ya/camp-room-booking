...
**運用期間**: 2026-09-02(水) と 2026-09-03(木) の2晩。各晩 22:00〜翌07:00（JST）。
...
| **セッション (session)** | **1晩の利用単位。22:00 から翌07:00 までの連続した9スロットを1セッションとする。`session_date` はその晩の開始日（JST）で識別する（例：9/2 22:00 も 9/3 03:00 も session_date = 2026-09-02）。** |
